        ...
        <div className="sibau-app-container">
            ...
            {alertMessage && (
                <div
                    style={{
                        ...
                        zIndex: 9999,
                        background:
                            alertType === 'success' ? '#10b981' : '#ef4444',
                        color: '#ffffff',
                        padding: '12px 20px',
                        borderRadius: '8px',
            ...
            <header className="sibau-header-bar">
                <div className="sibau-header-left">
                    ...
                    <div
                        className="sibau-header-title"
                        style={{ fontSize: '9.5pt', fontWeight: 'bold' }}
                    >
            ...
            <div style={{ display: 'flex', minHeight: 'calc(100vh - 56px)' }}>
                {/* Sidebar Navigation */}
                <aside
                    className={`sibau-sidebar ${sidebarCollapsed ? 'collapsed' : ''} ${mobileOpen ? 'block' : 'hidden md:flex'}`}
                >
                ...
                {/* Mobile Nav Trigger */}
                <div className="z-200 fixed right-3 top-3 md:hidden">
                    <button
                        onClick={() => setMobileOpen(!mobileOpen)}
                        className="rounded-md border border-gray-800 bg-black p-1.5 text-white"
                ...
                {/* Main Content Area */}
                <main
                    className={`sibau-main ${sidebarCollapsed ? 'collapsed' : ''}`}
                >
                    <div className="sibau-page-title-section">
                        <h2>
                            {subtitle
                                ? subtitle
                                : 'DASHBOARD SISTEM INFORMASI BERITA ACARA UJIAN'}
                        </h2>
                        <p>
                            Selamat Datang, {user.name} (
                            {isAdmin ? 'Fakultas Ekonomi' : 'Dosen Pengawas'})
                        </p>
                    </div>

                    {/* Page Content */}
                    <div className="sibau-page-content">{children}</div>
                </main>
            </div>
        </div>
    );
