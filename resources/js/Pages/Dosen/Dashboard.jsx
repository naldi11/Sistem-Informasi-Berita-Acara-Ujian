            ...
            <div className="sibau-stats-grid">
                ...
                <div className="sibau-card sibau-stat-card">
                    ...
                    <div className="sibau-stat-card-body">
                        ...
                        <div className="sibau-stat-details">
                            <div className="sibau-stat-val">{todaySchedules.length} JADWAL UJIAN AKTIF</div>
                            {activeToday ? (
                                <>
                ...
                <div className="sibau-card sibau-stat-card">
                    ...
                    <div className="sibau-stat-card-body">
                        ...
                        <div className="sibau-stat-details">
                            <div className="sibau-stat-val">{stats.draft_bau + stats.pending_bau} BAU BELUM SELESAI</div>
                            <div className="sibau-stat-sub">Menunggu Input Data / Validasi</div>
                        </div>
                    </div>
                </div>
                ...
                <div className="sibau-card sibau-stat-card">
                    ...
                    <div className="sibau-stat-card-body">
                        ...
                        <div className="sibau-stat-details">
                            ...
                            <div className="sibau-stat-sub">Arsip berita acara ujian tervalidasi</div>
                        </div>
                    </div>
                </div>
            </div>
