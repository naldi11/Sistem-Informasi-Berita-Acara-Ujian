...
export default function Index({ courses, prodis }) {
    ...
    const submit = (e) => {
        ...
        if (editingCourse) {
            form.put(
                route('admin.matakuliah.update', {
                    kode_mk: editingCourse.kode_mk,
                }),
                {
                        ...
                        <tbody>
                            {filteredCourses.map((c) => (
                                <tr key={c.kode_mk}>
                                    ...
                                    <td>
                                        <span
                                            className={`sibau-badge ${c.status === 'aktif' ? 'badge-success' : 'badge-danger'}`}
                                        >
                                            {c.status}
                                        </span>
                                    </td>
                        ...
                        <form onSubmit={submitImport}>
                            <div className="sibau-modal-body">
                                ...
                                >
                                    ...
                                    <br />
                                    <strong>
                                        A: Kode MK, B: Nama Mata Kuliah, C:
                                        Jumlah SKS, D: Kode Prodi (e.g. AKT,
                                        MNJ), E: Semester, F: Teori (Ya/Tidak),
                                        G: Praktek (Ya/Tidak)
                                    </strong>
                                    <br />
                                    <span
