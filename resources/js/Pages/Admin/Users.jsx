...
export default function Users({
    ...
    courses = [],
    filters = {},
    importDefaultPassword = null,
}) {
    // Pencarian dijalankan di server karena daftar sudah dipaginasi.
    const [dosenSearch, setDosenSearch] = useState(filters.cari_dosen || '');
    const [mahasiswaSearch, setMahasiswaSearch] = useState(
        filters.cari_mahasiswa || '',
    );
    const [activeTab, setActiveTab] = useState(filters.tab || 'dosen');
    ...
    const submitDosen = (e) => {
        ...
        if (editingDosen) {
            dosenForm.put(
                route('admin.users.updateDosen', { nip: editingDosen.nip }),
                {
    ...
    const submitMahasiswa = (e) => {
        ...
        if (editingMahasiswa) {
            mahasiswaForm.put(
                route('admin.users.updateMahasiswa', {
    ...
    const deleteDosen = (nip) => {
        if (
            confirm(
                'Apakah Anda yakin ingin menghapus dosen ini? User account terkait juga akan terhapus.',
            )
        ) {
    ...
    const deleteMahasiswa = (nim) => {
        if (confirm('Apakah Anda yakin ingin menghapus mahasiswa ini?')) {
            mahasiswaForm.delete(
                route('admin.users.deleteMahasiswa', { nim: nim }),
            );
        }
    };

    // Kirim kata kunci ke server setelah pengetikan berhenti sejenak.
    ...
    useEffect(() => {
        ...
        const timer = setTimeout(() => {
            router.get(
                route('admin.users'),
                {
                    cari_dosen: dosenSearch,
                    cari_mahasiswa: mahasiswaSearch,
                    tab: activeTab,
                },
    ...
    }, [dosenSearch, mahasiswaSearch, activeTab]);
                ...
                <div className="sibau-card" style={{ padding: '20px' }}>
                    ...
                    <div className="sibau-table-container">
                        <table className="sibau-table">
                            ...
                            <tbody>
                                {dosens.data.map((d) => {
                                    const ampuMK = Array.isArray(
                                        d.ampu_mata_kuliah,
                                    )
                                        ? d.ampu_mata_kuliah
                                        : [];
                                    const ampuKelas = Array.isArray(
                                        d.ampu_kelas,
                                    )
                                        ? d.ampu_kelas
                                        : [];
                                    return (
                                        <tr key={d.nip}>
                                                    ...
                                                    {ampuMK.length > 0 ? (
                                                        ampuMK.map((mk) => {
                                                            ...
                                                            return (
                                                                <span
                                                                    key={mk}
                                                                    className="sibau-badge badge-info"
                                                                    style={{
                                                                        fontSize:
                                                                            '7.5pt',
                                                                        padding:
                                                ...
                                                >
                                                    {ampuKelas.length > 0 ? (
                                                        ampuKelas.map((k) => (
                                                            <span
                                                                key={k}
                                                                className="sibau-badge badge-warning"
                                                                style={{
                                                                    fontSize:
                                                                        '7.5pt',
                                                                    padding:
                                            ...
                                            <td>
                                                <span
                                                    className={`sibau-badge ${d.status === 'aktif' ? 'badge-success' : 'badge-danger'}`}
                                                >
                                                    {d.status}
                                                </span>
                                            </td>
                                            <td>
                                                ...
                                                >
                                                    ...
                                                    <button
                                                        ...
                                                        className="sibau-btn sibau-btn-danger sibau-btn-sm"
                                                        style={{
                                                            padding: '4px 8px',
                                                        }}
                                                    >
                                ...
                                {dosens.data.length === 0 && (
                                    <tr>
                                        ...
                                        >
                                            Tidak ada data dosen yang cocok.
                                        </td>
                                    </tr>
                                )}
                            </tbody>
            ...
            {activeTab === 'mahasiswa' && (
                <div className="sibau-card" style={{ padding: '20px' }}>
                    ...
                    >
                        ...
                        <div style={{ display: 'flex', gap: '8px' }}>
                            <button
                                onClick={() => setImportMahasiswaOpen(true)}
                                className="sibau-btn sibau-btn-secondary sibau-btn-sm"
                            >
                                📁 Import Mahasiswa
                            </button>
                            <button
                                onClick={openAddMahasiswa}
                                className="sibau-btn sibau-btn-primary sibau-btn-sm"
                            >
                                + Tambah Mahasiswa
                            </button>
                            ...
                            <tbody>
                                {mahasiswas.data.map((m) => (
                                    <tr key={m.nim}>
                                        ...
                                        <td>
                                            <span
                                                className={`sibau-badge ${m.status === 'aktif' ? 'badge-success' : m.status === 'cuti' ? 'badge-warning' : 'badge-danger'}`}
                                            >
                                                {m.status}
                                            </span>
                                        </td>
                    ...
                    <Pagination paginator={mahasiswas} />
                </div>
            )}
                ...
                <div className="sibau-modal-overlay">
                    <div className="sibau-modal">
                        <div className="sibau-modal-header">
                            <h3 className="sibau-modal-title">
                                {editingDosen
                                    ? 'Edit Data Dosen'
                                    : 'Tambah Dosen Baru'}
                            </h3>
                        ...
                        <form onSubmit={submitDosen}>
                            <div className="sibau-modal-body">
                                ...
                                <div className="sibau-form-group">
                                    <label className="sibau-label">
                                        Mata Kuliah yang Diampu (Multi-select)
                                    </label>
                                    <SearchableSelect
                                        options={courses.map((c) => ({
                                            value: c.kode_mk,
                                            label: `${c.nama_mk} (${c.kode_mk})`,
                                        }))}
                                    ...
                                    />
                                    {dosenForm.errors.ampu_mata_kuliah && (
                                        <div
                                            style={{
                                                color: 'red',
                                                fontSize: '9pt',
                                ...
                                {editingDosen && (
                                    <div className="sibau-form-group">
                                        ...
                                        >
                                            Akun dosen hasil impor dibuat dengan
                                            kata sandi acak. Setel di sini lalu
                                            sampaikan ke dosen yang
                                            bersangkutan.
                                        </span>
                                        {dosenForm.errors.password && (
                                            <div
                ...
                <div className="sibau-modal-overlay">
                    <div className="sibau-modal">
                        <div className="sibau-modal-header">
                            ...
                            <button
                                onClick={() => setMahasiswaModalOpen(false)}
                                className="sibau-modal-close"
                            >
                                ×
                            </button>
                ...
                <div className="sibau-modal-overlay">
                    <div className="sibau-modal">
                        <div className="sibau-modal-header">
                            ...
                            <button
                                onClick={() => setImportDosenOpen(false)}
                                className="sibau-modal-close"
                            >
                                ×
                            </button>
                        ...
                        <form onSubmit={submitImportDosen}>
                            <div className="sibau-modal-body">
                                <div className="sibau-form-group">
                                    ...
                                    <input
                                        ...
                                        required
                                    />
                                    {importDosenForm.errors.excel_file && (
                                        <div
                                            style={{
                                                color: 'red',
                                                fontSize: '9pt',
                                ...
                                >
                                    💡 <strong>Info Format Kolom Excel:</strong>
                                    <br />
                                    Data harus berada pada Sheet pertama dengan
                                    format kolom:
                                    <br />
                                    <strong>
                                        A: NIP, B: Nama Dosen, C: Kode Prodi
                                        (e.g. AKT, MNJ), D: Jabatan Akademik, E:
                                        Email (Opsional), F: Mata Kuliah Diampu
                                        (Kode MK, pisah koma), G: Kelas Diampu
                                        (pisah koma)
                                    </strong>
                                    <br />
                                    <span
                                    ...
                                    >
                                        * Baris pertama diasumsikan sebagai
                                        Header (dilewati saat impor). Akun dosen
                                        yang belum ada dibuat dengan kata sandi{' '}
                                        ...
                                        ; ubah lewat tombol ✏️ Edit pada dosen
                                        tersebut. Kata sandi akun yang{' '}
                                        <strong>sudah ada</strong> tidak pernah
                                        diubah oleh impor.
                                    </span>
                                </div>
                            </div>
                            <div className="sibau-modal-footer">
                                ...
                                <button
                                    type="submit"
                                    disabled={importDosenForm.processing}
                                    className="sibau-btn sibau-btn-primary"
                                >
                                    Unggah & Import
                                </button>
                ...
                <div className="sibau-modal-overlay">
                    <div className="sibau-modal">
                        <div className="sibau-modal-header">
                            ...
                            <button
                                onClick={() => setImportMahasiswaOpen(false)}
                                className="sibau-modal-close"
                            >
                                ×
                            </button>
                        ...
                        <form onSubmit={submitImportMahasiswa}>
                            <div className="sibau-modal-body">
                                <div className="sibau-form-group">
                                    ...
                                    <input
                                        ...
                                        required
                                    />
                                    {importMahasiswaForm.errors.excel_file && (
                                        <div
                                            style={{
                                                color: 'red',
                                                fontSize: '9pt',
                                ...
                                >
                                    ...
                                    <br />
                                    <strong>
                                        A: NIM/NPM, B: Nama Mahasiswa, C: Kode
                                        Prodi (e.g. AKT, MNJ), D: Angkatan, E:
                                        Kelas (Opsional)
                                    </strong>
                                    <br />
                                    <span
                            ...
                            <div className="sibau-modal-footer">
                                ...
                                <button
                                    type="submit"
                                    disabled={importMahasiswaForm.processing}
                                    className="sibau-btn sibau-btn-primary"
                                >
                                    Unggah & Import
                                </button>
