...
export default function Pengaturan({ users }) {
    ...
    const deleteStaff = (id) => {
        if (confirm('Apakah Anda yakin ingin menghapus staf ini?')) {
            staffForm.delete(
                route('admin.pengaturan.staff.delete', { id: id }),
            );
        }
    };
                            ...
                            <tbody>
                                {users.map((u) => (
                                    <tr key={u.id}>
                                        ...
                                        >
                                            <span
                                                className={`sibau-badge ${u.role === 'admin' ? 'badge-info' : 'badge-draft'}`}
                                            >
                                                {u.role}
                                            </span>
                                        </td>
                                        <td>
                                            <span
                                                className={`sibau-badge ${u.status === 'aktif' ? 'badge-success' : 'badge-danger'}`}
                                            >
                                                {u.status}
                                            </span>
                                        </td>
