...
export default function BeritaAcaraList({ baus, stats, filters = {} }) {
    ...
    const handleValidate = (id, status) => {
        if (
            confirm(
                `Apakah Anda yakin ingin memvalidasi berita acara ini menjadi: ${status.toUpperCase()}?`,
            )
        ) {
    ...
    const pending = stats?.menunggu_validasi ?? 0;
    const validated = stats?.tervalidasi ?? 0;
            ...
            <div className="sibau-stats-grid">
                        ...
                        <div className="sibau-stat-icon-wrapper">
                            ...
                            >
                                <path
                                    ...
                                    strokeLinejoin="round"
                                    strokeWidth="1.5"
                                    d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m2.25 0H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9zM12 11.25v3.375m1.5-1.5h-3"
                                />
                            </svg>
                        </div>
                        <div className="sibau-stat-details">
                ...
                <div className="sibau-card sibau-stat-card">
                    ...
                    <div className="sibau-stat-card-body">
                        ...
                        <div className="sibau-stat-details">
                            <div className="sibau-stat-val">
                                {validated} TELAH VALIDASI
                            </div>
                            <div className="sibau-stat-sub">
                                Telah disetujui Kaprodi
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            {baus.data.map((b, idx) => (
                                <tr key={b.id}>
                                    ...
                                    <td>
                                        ...
                                        >
                                            MK: {b.jadwal_ujian.kode_mk} |
                                            Kelas: {b.jadwal_ujian.kelas}
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        >
                                            Aktual:{' '}
                                            {b.jam_mulai_aktual
                                                ? b.jam_mulai_aktual.substring(
                                                      0,
                                                      5,
                                                  )
                                                : '-'}{' '}
                                            -{' '}
                                            {b.jam_selesai_aktual
                                                ? b.jam_selesai_aktual.substring(
                                                      0,
                                                      5,
                                                  )
                                                : '-'}{' '}
